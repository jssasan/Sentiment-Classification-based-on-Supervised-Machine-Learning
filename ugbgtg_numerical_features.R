...
## Unigram + bigram + trigram + numerical Features
...
results_algo_runner_ugbgtg_Numerical_features_only <- function(original_df, negpos_so_features_df, pos_tagged_fetues_df, sparsity, category_name){
  ...
  filename <-paste("UGBGTG_Composite_PRF_accuracy_mean_", category_name, sep = "")
  
  save(algo_runner_ugbgtg_composite_f300, file = paste(filename, ".Rda", sep = ""))
  
  write.csv(algo_runner_ugbgtg_composite_f300, file = paste(filename, ".csv", sep = ""))
  
  return(algo_runner_ugbgtg_composite_f300)
...
sink("PRFA_ugbgtg_numerical_2k_all_categories.txt")

UGBGTG_Numerical_PRF_accuracy_mean_scores_2k_mob <- results_algo_runner_ugbgtg_Numerical_features_only(original_df = df_imp_2k_f_mob_org,
...
UGBGTG_Numerical_PRF_accuracy_mean_scores_2k_cam <- results_algo_runner_ugbgtg_Numerical_features_only(original_df = df_imp_2k_f_cam_org,
...
UGBGTG_Numerical_PRF_accuracy_mean_scores_2k_tab <- results_algo_runner_ugbgtg_Numerical_features_only(original_df = df_imp_2k_f_tab_org,
...
UGBGTG_Numerical_PRF_accuracy_mean_scores_2k_lap <- results_algo_runner_ugbgtg_Numerical_features_only(original_df = df_imp_2k_f_lap_org,
...
UGBGTG_Numerical_PRF_accuracy_mean_scores_2k_tv <- results_algo_runner_ugbgtg_Numerical_features_only(original_df = df_imp_2k_f_tv_org,
...
UGBGTG_Numerical_PRF_accuracy_mean_scores_2k_vs <- results_algo_runner_ugbgtg_Numerical_features_only(original_df = df_imp_2k_f_vs_org,
